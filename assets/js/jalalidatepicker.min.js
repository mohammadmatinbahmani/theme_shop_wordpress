!function () {
    ...
    !function () {
        var t = "jdp", n = "".concat(t, "-container"), e = "div.".concat(t, "-years"), i = "div.".concat(t, "-year"),
            ...
            s = "div.".concat(t, "-day"), h = "div.".concat(t, "-day-name"), c = "div.".concat(t, "-icon-plus"),
            u = "div.".concat(t, "-icon-minus"), d = "div.".concat(t, "-footer"), p = "div.".concat(t, "-btn-today"),
        ...
        var b = Number.isNaN || window.isNaN, x = function (t) {
            return void 0 === t
        }, I = function (t) {
            ...
            var c = s[0] || {}, u = 1, d = s.length, p = !1;
            for ("boolean" == typeof c && (p = c, c = s[u] || {}, u += 1), "object" !== C(c) && I(c) && (c = {}), u === d && (c = _, u -= 1); u < d; u++) if (n = s[u], !x(n) && null !== n) for (var y = 0; y < window.Object.keys(n).length; y++) {
            ...
            for (var t = Y(r, K.dpContainer), n = 0; n < 7; n++) Y(h + V(n), t, null, null, K.options.days[n]);
            for (var e, i, a = (e = K.initDate.year, i = K.initDate.month, [0, 31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, S(e) ? 30 : 29][i]), o = H(K.initDate.year, K.initDate.month, 1), c = 7 * Math.ceil((o + a) / 7) - 1, u = 1, d = function (n) {
                var e, i, o, r, h = H(K.initDate.year, K.initDate.month, u),
        ...
        var Q = {
            ...
            init: function (t) {
            ...
            }, options: Q, input: null, get dpContainer() {
                ...
                if (this.dpContainer.style.visibility === w) {
                    var t = this.input.getBoundingClientRect(), n = t.left, e = t.top, i = t.height,
...
function initWPPJalaliDatePicker() {
    jalaliDatepicker.startWatch({
        selector: '.date-picker,input.hasDatepicker,input.sale_price_dates_to',
        separatorChar: "-",
        zIndex: 999999999
    })
}
