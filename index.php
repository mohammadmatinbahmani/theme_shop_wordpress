<?php get_header() ?>
    ...
    <div class="container">
        <div class="row my-4">
            <div class="col-12">
                <img src="<?php echo get_template_directory_uri() ?>/assets/img/Group 603.png" class="img-fluid"
                     alt="slide">
            </div>
        </div>
        <div class="row">
                ...
                <a href="#" class="flex-grow-1 ml-lg-3">
                    <div class="card border-0 card-hover1 mb-4 mb-lg-0">
                        <div class="card-body text-center">
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/buttons.png"
                                 class="img-fluid" alt="dokme">
                ...
                <a href="#" class="flex-grow-1 ml-lg-3">
                    <div class="card border-0 card-hover1 mb-4 mb-lg-0">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/delivery-truck.png"
                                 class="img-fluid" alt="kamion">
                        </div>
                    </div>
                </a>
                <a href="#" class="flex-grow-1 ml-lg-3">
                                ...
                                <a href="#">
                                    <div class="card border-0 brands">
                                        <div class="card-body py-3">
                                            <img src="<?php echo get_template_directory_uri() ?>/assets/img/Group 641.png"
                    ...
                    <div class="col-12 col-lg-3 my-4">
                        <div class="card border-0 card-hover-2">
                            <div class="card-img-top">
                                ...
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/Image 25.png"
                                     class="img-fluid card-img clip">
                            </div>
                            <div class="card-body">
                                <a href="#" class="d-block text-center" style="font-weight: 900;"> دکمه سرآستین کت مجلسی
                                    مردانه </a>
                            ...
                            <div class="card-footer bg-transparent">
                                <a href="#" class="btn btn-block"> <i class="fas fa-shopping-cart"></i> افزودن به سبد
                                    خرید </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <a href="#">
                            <div class="card border-0 ml-3 bg-transparent">
                                <div class="card-body p-0">
                                    <img src="<?php echo get_template_directory_uri() ?>/assets/img/Mask Group 4.png"
                            ...
                            <div class="slider3">
                                <div class="card border-0 mt-3 mb-3">
                                    <div class="card-body py-0">
                                        <img src="<?php echo get_template_directory_uri() ?>/assets/img/Mask Group 3.png"
                                             class="img-fluid mb-3" alt="sliderlastblog">
                    ...
                    <div class="card border-0 h-100">
                        <div class="card-body pt-0 px-1 pb-2">
                            ...
                            <div class="d-flex align-items-center card-hover-3 border-bottom py-2">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/businessman.png"
                                     class="img-fluid ml-2" alt="nazar">
                                <div>
